...
- ✅ Framework foundation & documentation (**checks**/)
...
- **Framework Documentation**: [**checks**/README.md](__checks__/README.md)
- **POM & Pattern Guides**: [**checks**/PATTERNS.md](__checks__/PATTERNS.md)
...
2. Consult [**checks**/QUICKSTART.md](__checks__/QUICKSTART.md) for pattern examples
