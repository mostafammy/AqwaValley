...
2. **Test the contract**
   ...
   it("should reject when utilization exceeds 100%", () => {
     const decision = deriveQuotaDecision({quotaM3: 10000, consumptionM3: 10001});
...
- **Framework**: See [__checks__/README.md](__checks__/README.md)
- **Test patterns**: See [__checks__/PATTERNS.md](__checks__/PATTERNS.md)
