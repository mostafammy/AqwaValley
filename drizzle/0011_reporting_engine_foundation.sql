...
CREATE INDEX "report_job_fingerprint_idx" ON "report_job" USING btree ("report_type", "normalized_parameters_hash", "snapshot_id", "template_version", "policy_version");--> statement-breakpoint
