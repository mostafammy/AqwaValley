...
/**
 * Seed initial roles, create two test user accounts via the internal auth API, and attach their role assignments.
 *
 * Seeds a predefined set of roles, ensures the presence of the required "admin" and "farmer" roles, creates two test users (or ensures they exist), and ensures each test user has the correct role assignment. On successful completion the process is terminated with exit code 0.
 *
