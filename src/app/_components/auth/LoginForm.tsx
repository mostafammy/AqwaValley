...
/**
 * Render a login form that authenticates users by national ID and redirects them according to their role.
 *
 * Displays inputs for national ID and password, shows authentication and authorization errors, and indicates loading state while submitting.
 *
 * @returns A React element that renders the login form UI and its behavior.
 */
